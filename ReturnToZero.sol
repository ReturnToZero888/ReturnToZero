...
/**
   ...
   #LIQ+#RFI+#SHIB+#DOGE, combine together to #ReturnToZero  

    I make this #ReturnToZero to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/ReturnToZeroTokenBSC
   ...
   I will renounce the ownership to burn addresses to transfer #ReturnToZero to the community, make sure it's 100% safe.

   I will add 0.999 BNB and all the left 49.5% total supply to the pool
   Can you make #ReturnToZero 10000000X? 
   ...
   it's the best part of the #ReturnToZero idea, increasing the liquidity pool automatically, 
...
contract ReturnToZero is Context, IERC20, Ownable {
    ...
    string private _name = "ReturnToZero";
    string private _symbol = "ReturnToZero";
